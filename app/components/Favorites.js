    ...
    props.forEach(channel => {
      ...
      $ul.innerHTML += `
        <li class="list-group-item d-flex justify-content-between align-items-center">
          ...
          <div>
            <a type="button" class="btn btn-outline-success" href="#/search=${tvgId}" onclick="window.open('https://www.highcpmgate.com/d3zfh6yqwx?key=0c23279a8ecbaa739a14a2bb32ffc8ad');">
