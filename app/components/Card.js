export function Card(props) {
  ...
  $div.innerHTML = `
    <div class="card m-auto">
      ...
      <a href="#/search=${tvgId}" class="card__arrow" onclick="window.open('https://www.highcpmgate.com/cvvyz5et?key=f627769ab5b6c120617013330ec7fc6d', '_blank', 'width=1000,height=600');">
